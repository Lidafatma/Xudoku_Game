document.addEventListener('DOMContentLoaded', () => {
    const materiData = {
        pengertian: `
            ...
            <div id="materi-body">
                ...
                <div class="concept-box" style="border-left: 6px solid #0077b6; background: #f0f7ff; margin: 25px 0;">
                    <h4 style="color: #0077b6; margin-bottom: 8px;"><i class="fas fa-quote-left"></i> Rujukan Teori Pustaka</h4>
                    <p style="font-style: italic; color: #333; line-height: 1.5; margin-bottom: 5px;">
                    ...
                    <small style="display: block; font-weight: bold; color: #555;">
                        — Abdur Rahman As’ari, dkk. (2017). Buku Teks Matematika SMP/MTs Kelas VIII. Kemendikbud RI.
                    </small>
                    <hr style="border: 0; border-top: 1px dashed #bde0fe; margin: 10px 0;">
                    <p style="font-style: italic; color: #333; line-height: 1.5; margin-bottom: 5px;">
                        "Sistem persamaan linear dua variabel adalah sekumpulan dua atau lebih persamaan linear yang memiliki dua variabel yang sama dan diselesaikan secara bersamaan."
                    </p>
                    <small style="display: block; font-weight: bold; color: #555;">
                        — Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi (2022). Buku Matematika untuk SMP/MTs Kelas VIII.
                    </small>
                </div>
        ...
        eliminasi: `
            ...
            <div id="materi-body">
                ...
                <div class="step-container">
                    <div class="step-card">
                        <div class="step-number">1</div>
                        <div>Pilih variabel pertama yang ingin dieliminasi untuk mendapatkan nilai variabel kedua.</div>
                    </div>
                    <div class="step-card">
                        <div class="step-number">2</div>
                        <div>Samakan koefisien variabel tersebut dengan mengalikan persamaan dengan angka tertentu jika belum sama.</div>
                    </div>
                    <div class="step-card">
                        <div class="step-number">3</div>
                        <div>Jumlahkan atau kurangkan kedua persamaan secara bersusun hingga variabel tersebut hilang dan nilainya ditemukan.</div>
                    </div>
                    <div class="step-card">
                        <div class="step-number">4</div>
                        <div>Ulangi proses langkah di atas dengan mengeliminasi variabel sebaliknya untuk mencari nilai variabel yang tersisa.</div>
                    </div>
                </div>
                ...
                <div class="premium-equation-container" style="text-align: left;">
                    ...
                    <div style="background: #f0f7ff; padding: 20px; border-radius: 15px;">
                        ...
                        1. <b>Eliminasi y untuk mendapatkan nilai x</b> (karena koefisien y sudah sama, langsung dikurangkan secara bersusun):<br>
                        <div class="math-display-large" style="margin: 15px 0;">
                            $$ \\begin{array}{rcc} 2x + y &=& 7 \\\\ x + y &=& 4 \\\\ \\hline x &\\phantom{+ y}&=& 3 \\end{array} \\quad - $$
                        </div>
                        Maka ditemukan nilai $$ x = 3 $$<br><br>
                        2. <b>Eliminasi x untuk mendapatkan nilai y</b> (samakan koefisien x dengan mengalikan persamaan bawah dengan 2):<br>
                        $$ \\begin{cases} 2x + y = 7 & |\\times 1| \\\\ x + y = 4 & |\\times 2| \\end{cases} \\rightarrow \\begin{cases} 2x + y &= 7 \\\\ 2x + 2y &= 8 \\end{cases} $$
                        Kurangkan kedua persamaan baru secara bersusun untuk menghilangkan variabel x:<br>
                        <div class="math-display-large" style="margin: 15px 0;">
                            $$ \\begin{array}{rcc} 2x + \\phantom{2}y &=& 7 \\\\ 2x + 2y &=& 8 \\\\ \\hline -y &=& -1 \\end{array} \\quad - $$
                        </div>
                        $$ -y = -1 \\rightarrow y = 1 $$
                ...
                <div class="premium-equation-container" style="margin-top: 40px; text-align: left;">
                    ...
                    <div style="background: #f0f7ff; padding: 20px; border-radius: 15px;">
                        <b>Pembahasan:</b><br><br>
                        1. <b>Eliminasi y untuk mendapatkan nilai x</b> (samakan koefisien y dengan mengalikan persamaan bawah dengan 2):<br>
                        $$ \\begin{cases} 3x + 2y = 12 & |\\times 1| \\\\ x + y = 5 & |\\times 2| \\end{cases} \\rightarrow \\begin{cases} 3x + 2y &= 12 \\\\ 2x + 2y &= 10 \\end{cases} $$
                        Kurangkan kedua persamaan secara bersusun untuk menghilangkan variabel y:<br>
                        <div class="math-display-large" style="margin: 15px 0;">
                            $$ \\begin{array}{rcc} 3x + 2y &=& 12 \\\\ 2x + 2y &=& 10 \\\\ \\hline x &\\phantom{+ 2y}&=& 2 \\end{array} \\quad - $$
                        </div>
                        Maka ditemukan nilai $$ x = 2 $$<br><br>
                        2. <b>Eliminasi x untuk mendapatkan nilai y</b> (samakan koefisien x dengan mengalikan persamaan bawah dengan 3):<br>
                        $$ \\begin{cases} 3x + 2y = 12 & |\\times 1| \\\\ x + y = 5 & |\\times 3| \\end{cases} \\rightarrow \\begin{cases} 3x + 2y &= 12 \\\\ 3x + 3y &= 15 \\end{cases} $$
                        Kurangkan kedua persamaan baru secara bersusun untuk menghilangkan variabel x:<br>
                        <div class="math-display-large" style="margin: 15px 0;">
                            $$ \\begin{array}{rcc} 3x + 2y &=& 12 \\\\ 3x + 3y &=& 15 \\\\ \\hline -y &=& -3 \\end{array} \\quad - $$
                        </div>
                        $$ -y = -3 \\rightarrow y = 3 $$
       ...
       campuran: `
            ...
            <div id="materi-body">
                ...
                <div class="premium-equation-container" style="text-align: left;">
                    ...
                    <div style="background: #f0f7ff; padding: 20px; border-radius: 15px;">
                        <b>Pembahasan:</b><br><br>
                        1. <b>Eliminasi y untuk mencari nilai x</b> (karena koefisien sudah sama namun beda tanda, kita gunakan penjumlahan bersusun):<br>
                        <div class="math-display-large" style="margin: 15px 0;">
                            $$ \\begin{array}{rcc} x + y &=& 5 \\\\ x - y &=& 1 \\\\ \\hline 2x &\\phantom{+ y}&=& 6 \\end{array} \\quad + $$
                        </div>
                        $$ 2x = 6 \\rightarrow x = 3 $$<br>
                ...
                <div class="premium-equation-container" style="margin-top: 40px; text-align: left;">
                    ...
                    <div style="background: #f0f7ff; padding: 20px; border-radius: 15px;">
                        <b>Pembahasan:</b><br><br>
                        1. <b>Eliminasi x untuk mencari nilai y</b> (Kalikan persamaan bawah dengan 3 agar koefisien x sama, lalu kurangkan bersusun):<br>
                        $$ \\begin{cases} 3x + 2y = 12 & |\\times 1| \\\\ x + y = 5 & |\\times 3| \\end{cases} \\rightarrow \\begin{cases} 3x + 2y &= 12 \\\\ 3x + 3y &= 15 \\end{cases} $$
                        <div class="math-display-large" style="margin: 15px 0;">
                            $$ \\begin{array}{rcc} 3x + 2y &=& 12 \\\\ 3x + 3y &=& 15 \\\\ \\hline &\\phantom{3x}-y &=& -3 \\end{array} \\quad - $$
                        </div>
                        $$ -y = -3 \\rightarrow y = 3 $$<br>
                        
                        2. <b>Substitusi y = 3</b> ke persamaan $$ x + y = 5 $$:<br>
                        $$ x + 3 = 5 $$
    ...
    referensi: `
            <div class="course-header" style="background: linear-gradient(135deg, #002d5e 0%, #001f3f 100%);">
                <i class="fas fa-bookmark" style="font-size: 3em; margin-bottom: 15px; color: #fbc02d;"></i>
                <h2>Referensi Buku & Kutipan</h2>
                <p>Daftar pustaka ilmiah yang digunakan sebagai acuan materi SPLDV</p>
            </div>
            <div id="materi-body">
                <p>Seluruh materi pembelajaran Sistem Persamaan Linear Dua Variabel (SPLDV) dalam aplikasi <b>Xudoku Math Plus</b> disusun berdasarkan acuan standar kurikulum nasional dan buku teks matematika resmi yang terverifikasi.</p>
                
                <div class="concept-box" style="border-left: 6px solid #fbc02d; background: #fffde7;">
                    <h4>Pernyataan Kutipan Utama:</h4>
                    <p><i>"Visualisasi geometri dari SPLDV berupa dua buah garis lurus yang berpotongan pada satu titik koordinat kartesius merupakan representasi kebenaran mutlak dari himpunan penyelesaian tunggal sistem tersebut."</i></p>
                </div>

                <h4 style="margin: 30px 0 15px 0;"><i class="fas fa-book" style="color: var(--primary-color);"></i> Daftar Buku Acuan:</h4>
                <div class="step-container">
                    <!-- Buku 1 -->
                    <div class="step-card">
                        <div class="step-number" style="background: var(--primary-color); color: #fff;">1</div>
                        <div>
                            <strong>Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi (2022)</strong><br>
                            <span style="color: #555; font-style: italic;">Matematika untuk SMP/MTs Kelas VIII (Kurikulum Merdeka)</span>.<br>
                            <small style="color: #888;">Pusat Perbukuan Badan Standar, Kurikulum, dan Asesmen Pendidikan: Jakarta.</small>
                        </div>
                    </div>
                    
                    <!-- Buku 2 -->
                    <div class="step-card">
                        <div class="step-number" style="background: var(--primary-color); color: #fff;">2</div>
                        <div>
                            <strong>Abdur Rahman As’ari, dkk. (2017)</strong><br>
                            <span style="color: #555; font-style: italic;">Matematika SMP/MTs Kelas VIII Semester 1 (Kurikulum 2013 Edisi Revisi 2017)</span>.<br>
                            <small style="color: #888;">Kementerian Pendidikan dan Kebudayaan: Jakarta.</small>
                        </div>
                    </div>

                    <!-- Buku 3 -->
                    <div class="step-card">
                        <div class="step-number" style="background: var(--primary-color); color: #fff;">3</div>
                        <div>
                            <strong>Prof. Dr. Achmad Buchori, S.Pd., M.Pd., dkk.</strong><br>
                            <span style="color: #555; font-style: italic;">Teori Instruksional Matematika dan Pengembangan Media Interaktif Berbasis Game</span>.<br>
                            <small style="color: #888;">Referensi Utama Validasi Instrumen Akademis.</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    const levels = [
        ...
        // Level 2
        { type: 'sudoku', size: 6, customGrid: '6x4', board: [[4,0,6,0,2,5],[0,5,0,4,0,3],[2,0,5,0,4,1],[0,4,1,6,0,0]], solution: [[4,3,6,1,2,5],[1,5,2,4,6,3],[2,6,5,3,4,1],[3,4,1,6,5,2]], instruction: "Gunakan angka 1 sampai 6. Angka tidak boleh sama dalam satu baris, kolom, dan kotak 3x2." },
        // Level 3
